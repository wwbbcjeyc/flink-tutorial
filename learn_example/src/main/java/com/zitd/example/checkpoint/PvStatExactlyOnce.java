package com.zitd.example.checkpoint;

import com.zitd.example.checkpoint.utils.PvStatExactlyOnceKafkaUtil;
...
/**
 * 1 分钟一次CheckPoint，CheckPoint 语义 EXACTLY ONCE，从 Kafka 中读取数据，
 * 为了简化代码，所以 Kafka 中读取的直接就是 String 类型的 appId，按照 appId KeyBy 。也可以解析数据信息如时间或生成系统时间
 * appId+dateTime KeyBy()
...
public class PvStatExactlyOnce {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> appInfoSource = env.addSource(new FlinkKafkaConsumer010<>(
        ...
        appInfoSource.keyBy((KeySelector<String, String>) appId -> appId)
                .map(new RichMapFunction<String, Tuple2<String, Long>>() {
                    ...
                    public void open(Configuration parameters) throws Exception {
                        ...
                        // 初始化状态
                        pvState=  getRuntimeContext().getState(new ValueStateDescriptor<>("pvStat"
