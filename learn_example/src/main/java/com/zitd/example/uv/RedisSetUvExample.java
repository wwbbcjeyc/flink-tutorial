package com.zitd.example.uv;

import com.zitd.example.bean.UserVisitWebEvent;
import com.zitd.example.utils.GsonUtil;
import com.zitd.example.utils.UvExampleUtil;
...
public class RedisSetUvExample {
    public static void main(String[] args) throws Exception {
        ...
        FlinkKafkaConsumerBase<String> kafkaConsumer = new FlinkKafkaConsumer010<String>(
