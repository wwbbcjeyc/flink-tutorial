...
import com.zitd.example.bean.ApacheLog;
import com.zitd.example.bean.HotPageView;
import com.zitd.example.bean.SimpleAggFunction;
...
public class CaseHotPageViewAnalysis {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<ApacheLog> logDS = env
                .readTextFile("/Users/wangwenbo/Data/apache.log")
